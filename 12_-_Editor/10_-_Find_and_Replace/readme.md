...
The editor has a **Find** and **Replace** function.
Unfortunately the standard dialogs for this are in English.
For this reason, it is rebuilt here in German.
Since you can't simply replace the texts as is the case with the FileDialog.
If you are content with the English dialogs, you only have to adjust the menu for the find/replace functions, the rest happens automatically.

---
New replace dialog, I took this from the FPC sources and Germanized it.
...
The new find functions have been added to the menu.
