...
A clipboard was added here, so copying and pasting in the editor is also possible.
The clipboard is nothing other than an editor window that receives the data when you select copy.
So you can even make it visible.
...
You can also say with **NewWindows** whether the window should not be displayed visibly.
...
The new Edit functions have been added to the menu.
...
Here you can see how to create a window invisibly.
